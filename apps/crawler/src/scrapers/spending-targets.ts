import type { SpendingTargetsData, SpendingTarget } from "@moneyforward-daily-action/db/types";
import type { Page } from "playwright";
import { LARGE_CATEGORY_NAME_BY_ID } from "@moneyforward-daily-action/meta/categories";
